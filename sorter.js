...
this.quickSort = function(array) {qs(array);};
this.bubbleSort = function(array) {bs(array);};
this.insertionSort = function(array) {is(array);};
this.selectionSort = function(array) {ss(array);};
this.mergeSort = function(array) {ms(array);};
this.shellSort = function(array) {shs(array);};

this.log = function(text, opt) {lg(text, opt);};
